...
var file_passenger_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x12, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x2e, 0x70, 0x61, 0x73, 0x73,
	0x65, 0x6e, 0x67, 0x65, 0x72, 0x22, 0x12, 0x0a, 0x10, 0x50, 0x61, 0x73, 0x73, 0x65, 0x6e, 0x67,
	0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x13, 0x0a, 0x11, 0x50, 0x61, 0x73,
	0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x0b,
	0x0a, 0x09, 0x50, 0x61, 0x73, 0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x32, 0x12, 0x0a, 0x10, 0x50,
	0x61, 0x73, 0x73, 0x65, 0x6e, 0x67, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x42,
	0x14, 0x5a, 0x12, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x67, 0x65, 0x6e, 0x2f, 0x70, 0x61, 0x73, 0x73,
...
var file_passenger_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_passenger_proto_goTypes = []interface{}{
	(*PassengerRequest)(nil),  // 0: grpc_gen.passenger.PassengerRequest
	(*PassengerResponse)(nil), // 1: grpc_gen.passenger.PassengerResponse
	(*Passenger)(nil),         // 2: grpc_gen.passenger.Passenger
}
...
func file_passenger_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_passenger_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PassengerResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
