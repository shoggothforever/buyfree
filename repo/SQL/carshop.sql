...
ALTER TABLE "public"."passengers" OWNER TO "bf";
...
ALTER TABLE "public"."passenger_carts" OWNER TO "bf";
...
ALTER TABLE "public"."passenger_order_forms" OWNER TO "bf";
...
ALTER TABLE "public"."factories" OWNER TO "bf";
...
ALTER TABLE "public"."factory_products" OWNER TO "bf";
...
ALTER TABLE "public"."platforms" OWNER TO "bf";
...
ALTER TABLE "public"."devices" OWNER TO "bf";
...
ALTER TABLE "public"."driver_carts" OWNER TO "bf";
...
ALTER TABLE "public"."driver_order_forms" OWNER TO "bf";
...
ALTER TABLE "public"."device_products" OWNER TO "bf";
...
ALTER TABLE "public"."advertisements" OWNER TO "bf";
...
ALTER TABLE "public"."bank_card_infos" OWNER TO "bf";
...
ALTER TABLE "public"."ad_devices" OWNER TO "postgres";
