...
func LocAdd(c context.Context, rdb *redis.Client, key, lgt, lat, loc string) (interface{}, error) {
	return rdb.Do(c, "geoadd", key, lgt, lat, loc).Result()
}

// source:源点 destination: 终点 unit:默认为m,可选km:千米,mi:英里,ft：英尺)
func LocDist(c context.Context, rdb *redis.Client, key, source, destination, unit string) (interface{}, error) {
...
func LocRadiusWithDist(c context.Context, rdb *redis.Client, key, lgt, lat, radius string, unit string) (interface{}, error) {
...
func LocRadiusWithCoord(c context.Context, rdb *redis.Client, key, lgt, lat, radius string, unit string) (interface{}, error) {
